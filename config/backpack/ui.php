...
return [
    ...
    */
    ...
    'project_name' => getenv('APP_NAME') ?? 'Backpack Admin Panel',
    ...
    'project_logo' => '<b>Food</b> Delivery',
    ...
    'classes' => [
         ...
         * It defaults to: "table table-striped table-hover nowrap rounded card-table table-vcenter card-table
         * shadow-xs border-xs".
         */
        'table' => null,

        /**
         * Use this as fallback config for themes to pass classes to the table wrapper component displayed in
         * List Operation.
         */
        'tableWrapper' => null,
    ],
